...
class dna_tool_sets ():
    ...
    def orf_identifier (self):
        ...
        frame3_max_length_pos = max(frame3, key = lambda x: x[1])
        print ("The start position of longest ORF in frame1: %d\n"%frame3_max_length_pos[0])
        ...
        #What is the length of the longest forward ORF that appears in the
    ...
    def repeats_identifier(self, n):
        ...
        # Which one of the following repeats of length 7 has a maximum
        ...
        # Find all repeats of length 10 in the input file. Let's use Max to
